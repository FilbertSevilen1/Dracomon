...
const DRACO_META: {
  ...
  EndMon: {
    ...
    ultimateDesc: 'Scorches the earth with a 3s burning ground zone and launches powerfully skyward into an 8s hovering flight (W / Up to ascend, S / Down to descend), sprouting a secondary set of wings with both pairs spreading significantly wider into a 4-winged Dragon Overlord! Basic attack fires 2 homing bullets simultaneously. Skill unleashes a devastating homing Dragonic Flare Beam that incinerates enemies in its path, creates a 3s burning ground zone, and pulverizes 1-block radius terrain on impact! All damage dealt is boosted by +10% per level during this form.',
    cost: 500,
