...
export default function Home() {
  ...
  const companionShowcase = [
    ...
    },
    {
      ...
      lore: 'Inspired by the legendary Dragonic Overlord The End. Wields a high-velocity dragon rifle with an 800px range cap, unleashes Dragonic Fire Breath to burn enemies and scorch the ground for 3 seconds, and ascends into Eternal Apocalypse — gaining 8 seconds of infinite flight, sprouting a secondary set of wings with both pairs spreading significantly wider into a 4-winged Dragon Overlord, firing dual homing bullets, and launching an enhanced fireball that destroys 1-block radius ground and burns the area, with all damage boosted +10% per level!',
      signatureSkill: 'Dragonic Fire Breath (Flamethrower Breath • 3s Burning Ground Zone)',
      ultimateSkill: 'Eternal Apocalypse (100 Energy • 8s Infinite Flight • 4 Wider Blazing Wings • Dual Homing Bullets • Enhanced Terrain-Crushing Fireball • +10% Dmg / Level)',
      color: 'red',
