        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-stone-200 pb-6">
          <div>
            ...
            <p className="text-xs md:text-sm text-stone-500 mt-1 max-w-2xl leading-relaxed">
              Inspect all 10 dragon guardians, compare base attributes, test live 60 FPS combat previews against Immortal Slime, unlock new companions, and equip your active partner.
            </p>
          </div>
        </div>
